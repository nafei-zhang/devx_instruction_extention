...
exports.renderFetchPanelHtml = renderFetchPanelHtml;
const fs = __importStar(require("fs"));
const path = __importStar(require("path"));
let cachedTemplate = null;
function readTemplate(extensionUri) {
    if (cachedTemplate)
...
function renderFetchPanelHtml(extensionUri, webview) {
...
//# sourceMappingURL=fetchPanelTemplate.js.map